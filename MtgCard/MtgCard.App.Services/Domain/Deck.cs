		...
		public List<ConstructedFormat> LegalConstructedFormats { get
			{
				...
				var allFormatsTypes = new List<Type>();
				allFormatsTypes.Add(typeof(Modern));
				allFormatsTypes.Add(typeof(Legacy));
				allFormatsTypes.Add(typeof(Vintage));
				allFormatsTypes.Add(typeof(Commander));
